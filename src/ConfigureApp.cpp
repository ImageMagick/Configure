...
void ConfigureApp::cleanupFolders(ConfigureOptions &options,WaitDialog &waitDialog) const
{
...
BOOL ConfigureApp::createFiles(ConfigureOptions &options,WaitDialog &waitDialog) const
{
...
void ConfigureApp::writeImageMagickFiles(const ConfigureOptions &options,const VersionInfo &versionInfo,WaitDialog &waitDialog) const
{
