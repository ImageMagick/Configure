...
void Project::writeLibProperties(wofstream& file) const
{
  file << "  <ItemDefinitionGroup>" << endl;
  file << "    <ClCompile>" << endl;
  file << "      <ProgramDataBaseFileName>$(SolutionDir)Artifacts\\pdb\\$(TargetName).pdb</ProgramDataBaseFileName>" << endl;
  file << "    </ClCompile>" << endl;
  file << "    <Lib>" << endl;
...
void Project::writeLinkProperties(wofstream& file) const
{
  file << "  <ItemDefinitionGroup>" << endl;
  file << "    <Link>" << endl;
  file << "      <AdditionalLibraryDirectories>$(SolutionDir)Artifacts\\lib;$(SolutionDir)Artifacts\\pdf;%(AdditionalLibraryDirectories)</AdditionalLibraryDirectories>" << endl;
