...
void Solution::write(const ConfigureOptions &options,const vector<Project> &projects)
{
  ...
  writeProjectFolder(file,L"Demos");
...
void Solution::writeProjectsConfiguration(wofstream& file,const ConfigureOptions& options,const vector<Project>& projects)
{  
